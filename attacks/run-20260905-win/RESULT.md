# Spinkatron Windows OS-exclude smoke (2026-09-05)
...
## Verdict
**OS exclude WORKS on Spinkatron (Windows)** for GDI screen capture: API engages and canary text does not appear in the screenshot. Control run proves the canary is visible when exclude is off.
